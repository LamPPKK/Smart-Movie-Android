...
fun strings(locale: AppLocale): UiStrings = when (locale) {
    AppLocale.ENGLISH -> UiStrings(
        "Home", "Explore", "Search", "Library", "Movies", "TV Series", "Discover",
        "Search movies and TV series", "All", "Favorites", "Watchlist", "Favorite", "Watch later",
    ...
    AppLocale.VIETNAMESE -> UiStrings(
        "Trang chủ", "Khám phá", "Tìm kiếm", "Thư viện", "Phim điện ảnh", "Phim bộ", "Khám phá",
        "Tìm phim điện ảnh và phim bộ", "Tất cả", "Yêu thích", "Xem sau", "Yêu thích", "Xem sau",
    ...
    AppLocale.JAPANESE -> UiStrings(
        "ホーム", "見つける", "検索", "ライブラリ", "映画", "テレビ", "作品を探す",
        "映画とテレビ番組を検索", "すべて", "お気に入り", "ウォッチリスト", "お気に入り", "後で見る",
    ...
    AppLocale.KOREAN -> UiStrings(
        "홈", "둘러보기", "검색", "라이브러리", "영화", "TV 시리즈", "작품 찾기",
        "영화 및 TV 시리즈 검색", "전체", "즐겨찾기", "관심 목록", "즐겨찾기", "나중에 보기",
    ...
    AppLocale.CHINESE_SIMPLIFIED -> UiStrings(
        "首页", "探索", "搜索", "片库", "电影", "剧集", "发现作品",
        "搜索电影和剧集", "全部", "收藏", "想看", "收藏", "稍后观看",
    ...
    AppLocale.CHINESE_TRADITIONAL -> UiStrings(
        "首頁", "探索", "搜尋", "片庫", "電影", "影集", "探索作品",
        "搜尋電影和影集", "全部", "收藏", "待看清單", "收藏", "稍後觀看",
