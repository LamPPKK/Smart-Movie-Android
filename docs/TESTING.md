...
| Feature models | Variable | Home, Explore, entity Search/Detail, catalog editorial and media-gallery filtering/deduplication, Library, Profile, adult PIN, rating, and custom-list state |
